...
- **`bsm_generation_frequency`:** How often the message is created and broadcast. Default value is 10 hz.
...
- **CARMA Platform:** CARMA Platform provides the navigation and guidance functions for its host vehicle, as well as some of the control functions. It depends on low level controller hardware to provide the rest of the control function.
